...
<body class="h-full">
    ...
    <header class="bg-white">
		...
		<ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
			<li><a class="rounded-md px-3 py-2 font-medium text-sm text-gray-700 hover:text-white hover:underline hover:bg-gray-700" href="/">Home</a></li>
			
			<li><a class="rounded-md px-3 py-2 font-medium text-sm text-gray-700 hover:text-white hover:underline hover:bg-gray-700" href="#">About Us</a></li>
			
			<li><a class="rounded-md px-3 py-2 font-medium text-sm text-gray-700 hover:text-white hover:underline hover:bg-gray-700" href="#">Category</a></li>
			
			
			<li><a class="rounded-md px-3 py-2 font-medium text-sm text-gray-700 hover:text-white hover:underline hover:bg-gray-700" href="#">Contact</a></li>
		</ul>
