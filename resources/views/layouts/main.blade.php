            ...
            @auth
                <div x-data="{ open: false }" class="relative">
                    ...
                    <button @click="open = !open"
                        class="flex items-center space-x-2 bg-white text-gray-700 px-4 py-2 rounded-md hover:bg-gray-100 focus:outline-none">
                        <div
                            class="w-8 h-8 flex items-center justify-center bg-gray-300 rounded-full text-white font-semibold">
